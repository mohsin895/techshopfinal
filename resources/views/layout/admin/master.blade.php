...
<head>
    ...
    <link href="{{asset('public/assets/admin')}}/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css" rel="stylesheet"
        type="text/css" />
...
<body id="kt_body"
            ...
            <div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true"
                ...
                <div class="aside-logo flex-column-auto" id="kt_aside_logo">
                    ...
                    <a href="{{route('admin.dashboard')}}">
                        <img alt="Logo" src="{{asset('public/assets/images/setting/'.$gs->dashboard_logo)}}" class="h-25px logo" />
                    </a>
                    <!--end::Logo-->
                    <!--begin::Aside toggler-->
                                ...
                                <div class="pe-3 mb-5">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="{{asset('public/assets/admin')}}/assets/media/avatars/300-14.jpg"
                                                alt="img" />
                                        </div>
                                        <!--end::User-->
                                    </div>
                                ...
                                <div class="overflow-auto pb-5">
                                    ...
                                    <div
                                        ...
                                        <div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px pe-2">
                                            ...
                                            <div class="symbol symbol-circle symbol-25px">
                                                <img src="{{asset('public/assets/admin')}}/assets/media/avatars/300-2.jpg"
                                                    alt="img" />
                                            </div>
                                            <!--end::User-->
                                            <!--begin::User-->
                                    ...
                                    <div
                                        ...
                                        <div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px">
                                            <!--begin::User-->
                                            <div class="symbol symbol-circle symbol-25px">
                                                <img src="{{asset('public/assets/admin')}}/assets/media/avatars/300-20.jpg"
                                                    alt="img" />
                                            </div>
                                            <!--end::User-->
                                            <!--begin::User-->
                                ...
                                <div class="overflow-auto pe-3">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="{{asset('public/assets/admin')}}/assets/media/avatars/300-1.jpg"
                                                alt="img" />
                                        </div>
                                        <!--end::User-->
                                    </div>
                                ...
                                <div class="mb-5 pe-3">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="{{asset('public/assets/admin')}}/assets/media/avatars/300-23.jpg"
                                                alt="img" />
                                        </div>
                                        <!--end::User-->
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            ...
                                            <img alt="" class="w-30px me-3"
                                                src="{{asset('public/assets/admin')}}/assets/media/svg/files/pdf.svg" />
                                            <!--end::Icon-->
                                            <!--begin::Info-->
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            ...
                                            <img alt="../../demo1/dist/apps/projects/project.html" class="w-30px me-3"
                                                src="{{asset('public/assets/admin')}}/assets/media/svg/files/doc.svg" />
                                            <!--end::Icon-->
                                            <!--begin::Info-->
                                            <div class="ms-1 fw-bold">
                                                <!--begin::Desc-->
                                        ...
                                        <div class="d-flex flex-aligns-center">
                                            <!--begin::Icon-->
                                            <img alt="../../demo1/dist/apps/projects/project.html" class="w-30px me-3"
                                                src="{{asset('public/assets/admin')}}/assets/media/svg/files/css.svg" />
                                            <!--end::Icon-->
                                            <!--begin::Info-->
                                            <div class="ms-1 fw-bold">
                                                <!--begin::Desc-->
                                ...
                                <div class="overflow-auto pb-5">
                                    <div
                                        ...
                                        <div class="overlay me-10">
                                            ...
                                            <div class="overlay-wrapper">
                                                <img alt="img" class="rounded w-150px"
                                                    src="{{asset('public/assets/admin')}}/assets/media/stock/600x400/img-29.jpg" />
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Link-->
                                        ...
                                        <div class="overlay me-10">
                                            ...
                                            <div class="overlay-wrapper">
                                                <img alt="img" class="rounded w-150px"
                                                    src="{{asset('public/assets/admin')}}/assets/media/stock/600x400/img-31.jpg" />
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Link-->
                                            <div class="overlay-layer bg-dark bg-opacity-10 rounded">
                                        ...
                                        <div class="overlay">
                                            ...
                                            <div class="overlay-wrapper">
                                                <img alt="img" class="rounded w-150px"
                                                    src="{{asset('public/assets/admin')}}/assets/media/stock/600x400/img-40.jpg" />
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Link-->
                                            <div class="overlay-layer bg-dark bg-opacity-10 rounded">
                                ...
                                <div class="pe-3 mb-5">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="{{asset('public/assets/admin')}}/assets/media/avatars/300-4.jpg"
                                                alt="img" />
                                        </div>
                                        <!--end::User-->
                                    </div>
                        ...
                        <div class="d-flex flex-column align-items-start">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div class="symbol symbol-35px symbol-circle">
                                    <img alt="Pic" src="{{asset('public/assets/admin')}}/assets/media/avatars/300-25.jpg" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Details-->
                                <div class="ms-3">
                    ...
                    <div class="d-flex justify-content-end mb-10">
                        ...
                        <div class="d-flex flex-column align-items-end">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <!--begin::Avatar-->
                                <div class="symbol symbol-35px symbol-circle">
                                    <img alt="Pic" src="{{asset('public/assets/admin')}}/assets/media/avatars/300-1.jpg" />
                                </div>
                                <!--end::Avatar-->
                            </div>
                            <!--end::User-->
                            ...
                            <div class="row g-5">
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        ...
                                        <div class="overlay-wrapper">
                                            <img src="{{asset('public/assets/admin')}}/assets/media/demos/demo1.png" alt="demo"
                                                class="w-100" />
                                        </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        ...
                                        <div class="overlay-wrapper">
                                            <img src="{{asset('public/assets/admin')}}/assets/media/demos/demo2.png" alt="demo"
                                                class="w-100" />
                                        </div>
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                        <div class="overlay-wrapper">
                                            <img src="{{asset('public/assets/admin')}}/assets/media/demos/demo3.png" alt="demo"
                                                class="w-100" />
                                        </div>
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                        <div class="overlay-wrapper">
                                            <img src="{{asset('public/assets/admin')}}/assets/media/demos/demo4.png" alt="demo"
                                                class="w-100" />
                                        </div>
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                        <div class="overlay-wrapper">
                                            <img src="{{asset('public/assets/admin')}}/assets/media/demos/demo5.png" alt="demo"
                                                class="w-100" />
                                        </div>
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                        <div class="overlay-wrapper">
                                            <img src="{{asset('public/assets/admin')}}/assets/media/demos/demo6.png" alt="demo"
                                                class="w-100" />
                                        </div>
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                        <div class="overlay-wrapper">
                                            <img src="{{asset('public/assets/admin')}}/assets/media/demos/demo7.png" alt="demo"
                                                class="w-100" />
                                        </div>
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                        <div class="overlay-wrapper">
                                            <img src="{{asset('public/assets/admin')}}/assets/media/demos/demo8.png" alt="demo"
                                                class="w-100" />
                                        </div>
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                        <div class="overlay-wrapper">
                                            <img src="{{asset('public/assets/admin')}}/assets/media/demos/demo9.png" alt="demo"
                                                class="w-100" />
                                        </div>
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                        <div class="overlay-wrapper">
                                            <img src="{{asset('public/assets/admin')}}/assets/media/demos/demo10.png"
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                        <div class="overlay-wrapper">
                                            <img src="{{asset('public/assets/admin')}}/assets/media/demos/demo11.png"
                                                alt="demo" class="w-100" />
                                        </div>
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                        <div class="overlay-wrapper">
                                            <img src="{{asset('public/assets/admin')}}/assets/media/demos/demo12.png"
                                                alt="demo" class="w-100" />
                                        </div>
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                        <div class="overlay-wrapper">
                                            <img src="{{asset('public/assets/admin')}}/assets/media/demos/demo13.png"
                                                alt="demo" class="w-100" />
                                        </div>
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                        <div class="overlay-wrapper">
                                            <img src="{{asset('public/assets/admin')}}/assets/media/demos/demo14.png"
                                                alt="demo" class="w-100" />
                                        </div>
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                        <div class="overlay-wrapper">
                                            <img src="{{asset('public/assets/admin')}}/assets/media/demos/demo15.png"
                                                alt="demo" class="w-100" />
                                        </div>
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                        <div class="overlay-wrapper">
                                            <img src="{{asset('public/assets/admin')}}/assets/media/demos/demo16.png"
                                                alt="demo" class="w-100" />
                                        </div>
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                        <div class="overlay-wrapper">
                                            <img src="{{asset('public/assets/admin')}}/assets/media/demos/demo17.png"
                                                alt="demo" class="w-100" />
                                        </div>
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                        <div class="overlay-wrapper">
                                            <img src="{{asset('public/assets/admin')}}/assets/media/demos/demo18.png"
                                                alt="demo" class="w-100" />
                                        </div>
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                        <div class="overlay-wrapper">
                                            <img src="{{asset('public/assets/admin')}}/assets/media/demos/demo19.png"
                                                alt="demo" class="w-100" />
                                        </div>
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                        <div class="overlay-wrapper">
                                            <img src="{{asset('public/assets/admin')}}/assets/media/demos/demo20.png"
                                                alt="demo" class="w-100" />
                                        </div>
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                        <div class="overlay-wrapper">
                                            <img src="{{asset('public/assets/admin')}}/assets/media/demos/demo21.png"
                                                alt="demo" class="w-100" />
                                        </div>
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                        <div class="overlay-wrapper">
                                            <img src="{{asset('public/assets/admin')}}/assets/media/demos/demo22.png"
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                        <div class="overlay-wrapper">
                                            <img src="{{asset('public/assets/admin')}}/assets/media/demos/demo23.png"
                                                alt="demo" class="w-100 opacity-25" />
                                        </div>
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                            <div class="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                        <div class="overlay-wrapper">
                                            <img src="{{asset('public/assets/admin')}}/assets/media/demos/demo24.png"
                                                alt="demo" class="w-100 opacity-25" />
                                        </div>
                                        <div class="overlay-layer bg-dark bg-opacity-10">
                                            <div class="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon
    ...
    <script src="{{asset('public/assets/admin')}}/assets/js/custom/apps/ecommerce/sales/listing.js"></script>
    ...
    <script src="{{asset('public/assets/admin')}}/assets/js/custom/apps/ecommerce/customers/listing/export.js"></script>
    ...
    <script src="{{asset('public/assets/admin')}}/assets/js/custom/utilities/modals/new-address.js"></script>
    <script src="{{asset('public/assets/admin')}}/assets/js/custom/utilities/modals/users-search.js"></script>

    <!-- <script src="{{asset('public/assets/admin')}}/assets/js/custom/apps/ecommerce/catalog/save-product.js"></script>
    <script src="{{asset('public/assets/admin')}}/assets/js/custom/apps/ecommerce/catalog/save-category.js"></script> -->
    ...
    <!--end::Page Vendors Javascript-->
    <!--begin::Page Custom Javascript(used by this page)-->
    <script src="{{asset('public/assets/admin')}}/assets/js/custom/apps/ecommerce/catalog/categories.js"></script>
    <!-- <script src="https://gitcdn.github.io/bootstrap-toggle/2.2.2/js/bootstrap-toggle.min.js"></script> -->
    <!-- <script src="https://code.jquery.com/jquery-3.5.1.min.js"></script> -->
    <!-- <script src="{{asset('public/assets/admin')}}/assets/js/jquery-1.11.1.min.js"></script> -->
