            ...
            <div class="col-md-12">
                <div class="card mb-4 ">
                    ...
                    <div class="text-center mt-5">
                        ...
                        <img class="card-img-top" src="{{asset('public/image/frontLogos/empty_cart.png')}}"
                            alt="Card image cap">
                    </div>
                    <div class="card-body">
                        <p class="card-text text-center" style="font-size: 30px;font-weight: 500;">Your Cart is empty
                        </p>

                        <div class="d-flex justify-content-between align-items-center">
                            <div class="btn-group">
                                <a href="{{url('/')}}" class="btn btn-sm btn-outline-secondary text-danger">Continue To Shopping</a>
