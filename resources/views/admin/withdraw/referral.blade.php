    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Customer referral income</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">referral income</li>
                    <!--end::Item-->
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                        ...
                        <tbody class="fw-bold text-gray-600">
                            ...
                            $totalWithdraw = App\Models\Withdraw::where('user_id', $row->id)->sum('amount');
                         
                            $referallAmount = App\Models\OrderProduct::where('referral_id',$row->referral_id)->sum('price');
                            $row->range_amount;
                            if ($row->range_amount == 0) {
                            $amount = 0;
                            } else {
                            $amount = ($row->commision * $referallAmount) / $row->range_amount;
                            }
                            @endphp
                            ...
                            <tr>
                                ...
                                <td>{{$totalWithdraw}}&nbsp;&nbsp; {{$gs->currency}}</td>
