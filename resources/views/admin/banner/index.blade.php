            ...
            <div class="card card-flush">
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar">
                        <!--begin::Add customer-->
                        <a href="{{route('admin.banner.add')}}" class="btn btn-primary">Add Banner</a>
                            ...
                            <tr>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <a href="{{route('admin.banner.edit',$row->id)}}"
                                            ...
                                            <span class="symbol-label"
                                                style="background-image:url({{asset('public/assets/images/banner/'.$row->image)}});width:500px;height:200px"></span>
                                        </a>
                                        <!--end::Thumbnail-->
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="javascript:void(0)" record="banner" recordid="{{ $row->id }}"
