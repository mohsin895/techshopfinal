            ...
            <div class="card card-flush">
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar">
                        <!--begin::Add customer-->
                        <a href="{{route('admin.slider.add')}}" class="btn btn-primary">Add Slider</a>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <a href="{{route('admin.slider.edit',$row->id)}}"
                                            ...
                                            <span class="symbol-label"
                                                style="background-image:url({{asset('public/assets/images/slider/'.$row->image)}});width:500px;height:200px"></span>
                                        </a>
                                        <!--end::Thumbnail-->
                                        <div class="ms-5">
                                            <!--begin::Title-->
