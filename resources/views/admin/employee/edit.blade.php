...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
					...
					<li class="breadcrumb-item text-muted">
                        <a href="{{route('admin.employee.add')}}" class="text-muted text-hover-primary">{{$add}}</a>
                    </li>
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            <form id="kt_ecommerce_add_employee_form" class="form d-flex flex-column flex-lg-row" method="post"
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <!--end::Input-->
                                <!--begin::Description-->
                                <!-- <div class="text-muted fs-7">A employee name is required and recommended to be unique.
                                </div> -->
                                <!--end::Description-->
                            </div>
                            <!--end::Input group-->
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="email" name="email"  class="form-control mb-2" placeholder="Home Page Name"
                        ...
                        <div class="card-body pt-0">
                            ...
                            <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                                ...
                                <option value="{{$row->id}}" @if($employee->role_id == $row->id) selected="" @endif;>{{$row->name}}</option>
                                @endforeach
