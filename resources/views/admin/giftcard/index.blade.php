        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="{{route('admin.giftcard.add')}}" class="text-muted text-hover-primary">{{$add}}</a>
                    </li>
            ...
            <div class="card card-flush">
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar">
                        <!--begin::Add customer-->
                        <a href="{{route('admin.giftcard.add')}}" class="btn btn-primary">Add Giftcard</a>
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                        ...
                        <tbody class="fw-bold text-gray-600">
                            ...
                            <tr>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <a href="#">
                                            <span class="symbol-label"
                                                style="background-image:url({{asset('public/assets/images/giftcard/'.$row->image)}});width:300px;height:200px"></span>
                                        </a>
                                        <!--end::Thumbnail-->
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                ...
                                <td>
                                    <!--begin::Badges-->
                                    {{ $row->currency}}&nbsp;&nbsp;&nbsp; {{ $row->giftcard_value}}
                                    <!--end::Badges-->
                                </td>
                                <td>
                                <div class="form-check form-switch form-switch-sm form-check-custom form-check-solid">
														<input class="form-check-input" type="checkbox" {{$row->status=='1'? 'checked':''}} id="GiftcardStatus"
                                data-id="{{$row->id}}" />
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="{{route('admin.giftcard.edit',$row->id)}}"
                                                class="menu-link px-3" >Edit</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="javascript:void(0)" record="giftcard" recordid="{{ $row->id }}"
                            ...
                            <!--end::Table row-->
                            @include('admin.model.slider.edit')
                            @endforeach
                            <!--end::Table row-->
                        </tbody>
