    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            <form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row" method="post"
                action="{{route('admin.giftcard.update',$giftcard->id)}}" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body text-center pt-0">
                                ...
                                <div class="image-input image-input-empty image-input-outline mb-3"
                                    ...
                                    style="background-image: url({{asset('public/assets/images/giftcard/'.$giftcard->image)}})">
                                ...
                                <div class="text-muted fs-7">Set the category thumbnail image. Only *.png, *.jpg and
                                    *.jpeg image files are accepted,width:500px,height:245px</div>
                                <!--end::Description-->
                            </div>
                            <!--end::Card body-->
                        </div>
