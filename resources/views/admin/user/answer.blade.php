        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">User Question Answer</li>
                    <!--end::Item-->
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px">Answer Date</th>
                        ...
                        <tbody class="fw-bold text-gray-600">
                            ...
                            @php 
                            $Product = App\Models\Question::find($row->question_id);
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#"
                                        class="text-gray-800 text-hover-primary mb-1">{{$Product->question}}</a>
                                </td>
                                <!--end::Name=-->
                                <!--begin::Email=-->
                                <td>
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                        ...
                                        <div class="menu-item px-3">
                                                ...
                                                <a href="#" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#kt_modal_question_status_user{{$row->id}}">Status</a>
                                        </div>
                            ...
                            @include('admin.model.question.answer_status')
