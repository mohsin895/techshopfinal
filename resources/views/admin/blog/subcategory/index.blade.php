        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="{{route('admin.blog.subcategory.add')}}" class="text-muted text-hover-primary">{{$add}}</a>
                    </li>
            ...
            <div class="card card-flush">
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar">
                        <!--begin::Add customer-->
                        <a href="{{route('admin.blog.subcategory.add')}}" class="btn btn-primary">Add SubCategory</a>
                        <!--end::Add customer-->
                    </div>
                    <!--end::Card toolbar-->
                </div>
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                        ...
                        <tbody class="fw-bold text-gray-600">
                            ...
                            <tr>
                                @php
                                $category = App\Models\BlogCategory::find($row->parent_id);
                                @endphp
                               @if(!empty($category))
                                <!--begin::Checkbox-->
                                <td>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="ms-5">
                                            ...
                                            <a href="#"
                                                ...
                                                data-kt-ecommerce-category-filter="category_name">{{ $row->cat_name}}</a>
                                            <!--end::Title-->
                                            <!--begin::Description-->
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="{{route('admin.blog.subcategory.edit',$row->id)}}"
                                                class="menu-link px-3">Edit</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="javascript:void(0)" record="blogsubcategory" recordid="{{ $row->id }}"
