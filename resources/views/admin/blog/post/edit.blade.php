    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            <form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row" method="post"
                action="{{route('admin.blog.post.update',$post->id)}}" enctype="multipart/form-data">
                @csrf
                <!--begin::Aside column-->
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div>
                                ...
                                <!--end::Label-->
                                <div><textarea name="description" rows="4" cols="100"
                                        class="ckeditor">{!! $post->description !!}</textarea></div>
                            </div>
                            <!--end::Input group-->
                        </div>
                        <!--end::Card header-->
