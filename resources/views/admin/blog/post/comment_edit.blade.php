...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <!--begin::Post-->
    @php
    $post = App\Models\BlogPost::find($post_coment->post_id);
    @endphp
    <div class="post d-flex flex-column-fluid" id="kt_post">
        <!--begin::Container-->
        <div id="kt_content_container" class="container-xxl">
            <form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row" method="post"
                action="{{route('admin.blog.post.comment.reply.admin',$post_coment->id)}}" enctype="multipart/form-data">
                @csrf
                <!--begin::Aside column-->
                <input type="hidden" name="comment_id"  placeholder="Post Title"
                                    value="{{$post->id}}" />
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body text-center pt-0">
                            ...
                            <div class="image-input image-input-empty image-input-outline mb-3"
                                ...
                                style="background-image: url({{asset('public/assets/images/blog/'.$post->image)}})">
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                                ...
                                name="status">
                                <option></option>
                                <option value="new" @if($post->status=='new') ? selected="" @else @endif >New</option>
                                <option value="published" @if($post->status=='published') ? selected="" @else
                                    @endif>Published</option>


                                <option value="inactive" @if($post->status=='inactive') ? selected="" @else
                        ...
                        <div class="card-body pt-0">
                            <div class="mb-10 fv-row">
                                ...
                                <select class="form-select mb-2" name="parent_id" id="parent_id" data-control="select2"
                                    ...
                                    <option value="{{$row->id}}" @if($row->id==$post->cat_id) ? selected="" @else
                                        @endif>{{$row->cat_name}}</option>
                                    @endforeach
                                </select>
                                <!--end::Select2-->
                                <!--begin::Description-->
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <select class="form-select mb-2" name="subcat_id" id="subcat_id" data-control="select2"
                                    ...
                                    <option value="{{$row->id}}" @if($row->id==$post->subcat_id) ? selected="" @else
                                        @endif>{{$row->cat_name}}</option>
                                    @endforeach
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <!--end::Label-->
                                <div><textarea name="description" rows="10" cols="100"
                                        >{!! $post->description !!}</textarea></div>
                            </div>
                            <div class="mb-10 fv-row">
                                <!--begin::Label-->
                                ...
                                <!--end::Label-->
                                <div><textarea name="description" rows="10" cols="100"
                                        >{!! $post_coment->comment !!}</textarea></div>
                            </div>

                            <div class="mb-10 fv-row">
                                <!--begin::Label-->
                                <label class="form-label">Post Comment Reply</label>
                                <!--end::Label-->
                                <div><textarea name="comment" rows="4" cols="100"
                                        class="summernote"></textarea></div>
                            </div>
                            <!--end::Input group-->
                        </div>
                        <!--end::Card header-->
