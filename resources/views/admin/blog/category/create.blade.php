    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            <form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row" method="post"
                action="{{route('admin.blog.category.insert')}}" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="cat_name" class="form-control mb-2" placeholder="Category Name name"
                                    value="" />
                                <!--end::Input-->
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="homa_page_name" class="form-control mb-2" placeholder="Home Page name"
                                    value="" />
                                <!--end::Input-->
                                <!--begin::Description-->
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="number" name="serial_number" class="form-control mb-2" placeholder="Home Page Serial Number"
                                    value="" />
                                <!--end::Input-->
                                <!--begin::Description-->
