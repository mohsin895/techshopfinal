                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-150px">Show on Home Page</th>
                                <th class="min-w-150px">Home Page Name</th>
                                <th class="min-w-150px">Home Page Serial Number</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <!-- <div class=""><input type="checkbox" {{$row->status=='1'? 'checked':''}}
                                            id="blogcategoryStatus" data-id="{{$row->id}}" data-toggle="toggle"
                                    ...
                                    <div
                                        ...
                                        <input class="form-check-input" type="checkbox"
                                            {{$row->status=='1'? 'checked':''}} id="blogcategoryStatus"
                                            data-id="{{$row->id}}" />
                                        <label class="form-check-label">Yes</label>
                                    </div>
                                </td>
                                <td>{{ $row->homa_page_name}}</td>
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="javascript:void(0)" record="blogcategory" recordid="{{ $row->id }}"
