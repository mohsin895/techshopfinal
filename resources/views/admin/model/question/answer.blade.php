<div class="modal fade" id="kt_modal_question_answer{{$row->id}}" tabindex="-1" aria-hidden="true">
			<!--begin::Modal dialog-->
			<div class="modal-dialog modal-dialog-centered mw-650px">
				<!--begin::Modal content-->
				<div class="modal-content">
					<!--begin::Form-->
					<form class="form" action="{{route('admin.user.answer')}}" method="post" id="kt_modal_new_address_form">
						...
						<div class="modal-body py-10 px-lg-17">
							...
							<div class="scroll-y me-n7 pe-7" id="kt_modal_new_address_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_new_address_header" data-kt-scroll-wrappers="#kt_modal_new_address_scroll" data-kt-scroll-offset="300px">
                                ...
                                <div class="d-flex flex-column mb-5 fv-row">
									...
									<!--end::Label-->
									<!--begin::Select-->
									<textarea name="answer" rows="4" class="form-control answer-text" readonly>{{$row->question}}</textarea>
									<!--end::Select-->
								</div>
