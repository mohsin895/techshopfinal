            ...
            <div class="card card-flush">
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" data-kt-ecommerce-category-filter="search"
                                class="form-control form-control-solid w-250px ps-14" placeholder="Search Coupon Code" />
                        </div>
                        <!--end::Search-->
                    </div>
                    <!--end::Card title-->
                    ...
                    <div class="card-toolbar">
                        <!--begin::Add customer-->
                        <a href="{{route('admin.couponcode.add')}}" class="btn btn-primary">Add Coupon Code</a>
                        <!--end::Add customer-->
                    </div>
                    <!--end::Card toolbar-->
                </div>
                        ...
                        <tbody class="fw-bold text-gray-600">
                            ...
                            <tr>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <!-- <a href="{{route('admin.subcategory.edit',$row->id)}}"
                                            ...
                                            <span class="symbol-label"
                                                style="background-image:url({{asset('assets/images/subcategory/'.$row->image)}});"></span>
                                        </a> -->
                                        <!--end::Thumbnail-->
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="{{route('admin.couponcode.edit',$row->id)}}"
                                                ...
                                                data-kt-ecommerce-category-filter="category_name">{{ $row->coupon_code}}</a>
                                            <!--end::Title-->
                                            <!--begin::Description-->
                                ...
                                <td> <div class="form-check form-switch form-switch-sm form-check-custom form-check-solid">
														<input class="form-check-input" type="checkbox" {{$row->status=='1'? 'checked':''}} id="CouponCodeStatus"
                                data-id="{{$row->id}}" />
														<label class="form-check-label">Active</label>
													</div></td>
                                <td>
                                    <!--begin::Badges-->
                                    <div class="">{{ $row->expiry_date}}</div>
                                    <!--end::Badges-->
                                </td>
                                <!--end::Type=-->
                                <!--begin::Action=-->
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="javascript:void(0)" record="couponcode" recordid="{{ $row->id }}"
