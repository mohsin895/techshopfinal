    ...
    <div class="album py-5">
        <div class="container">
          ...
          @foreach($post as $row)
            <div class="col-md-4">
              <div class="card mb-4 ">
                <img class="card-img-top" src="{{asset('public/assets/images/blog/'.$row->image)}}" alt="Card image cap">
                <div class="card-body">
                  <p class="card-text">{{$row->title}}</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      <a href="{{route('blog.post.details',$row->slug)}}" class="btn btn-sm btn-outline-secondary">View Details</a>
